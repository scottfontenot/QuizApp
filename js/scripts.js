...
Function quizQuestion(){
	//Generate 1 question and 4 m/c answers in form
}

Function quizFeedback(){
	//Listen for "Answer" and provide feedback to user in the form of a correct or incorrect message. 
	//Update user on quiz progress and score, display button to take user to next question
}

Function quizFinal(){
	//Display final score and earned "Title" at end of quiz. Display button
	//to reset quiz 
}
